    ...
    <div className="fm-overlay" onClick={onClose}>
      <div className="fm-card animate-slide-up" onClick={(e) => e.stopPropagation()}>
        <div className="fm-header">
          <h3>
            {activeModal === 'about' && 'ABOUT POWER TANK NUTRITION 🏋️‍♂️'}
        ...
        <div className="fm-body scrollbar-styled">
          ...
          {activeModal === 'about' && (
            <div className="fm-about-content">
              <p className="fm-lead">
                Power Tank Nutrition was born in the iron pits, engineered for those who demand maximum performance and refuse to settle for under-dosed sports nutrition.
              </p>
              <p>
              ...
              <div className="fm-quote-block">
                ...
                <cite>— Power Tank Nutrition Team</cite>
              </div>
            </div>
          )}
            ...
            <div className="fm-verify-content">
              {verifyState === 'idle' && (
                <form onSubmit={handleVerify} className="fm-form">
                  <p className="fm-instruction">
                    Locate the 12-digit scratch authentication code printed on your Power Tank Nutrition tub neck label or lid scan code. Enter it below to check authenticity.
                  </p>
              ...
              {verifyState === 'success' && (
                <div className="fm-result-wrap fm-result-success animate-scale-up">
                  ...
                  <h3>100% GENUINE POWER TANK FUEL</h3>
                  ...
                  <div className="fm-cert-details">
                    ...
                    <div className="fm-cert-row"><span>Batch code:</span> <strong>PTN-882A-SUPP</strong></div>
              ...
              {verifyState === 'fail' && (
                <div className="fm-result-wrap fm-result-fail animate-scale-up">
                  ...
                  <p className="fm-fail-info">
                    The code entered does not match any batch code in our secure database. If you suspect this is a counterfeit product, please contact support immediately at support@powertanknutrition.com.
                  </p>
          ...
          {activeModal === 'contact' && (
            <div className="fm-contact-content">
              ...
              <div className="fm-contact-grid">
                ...
                <a href="mailto:support@powertanknutrition.com" className="fm-contact-card">
                  <div className="fm-cc-icon gold-glow"><Mail size={24} /></div>
                  <h4>Email Assistance</h4>
                  <p>support@powertanknutrition.com</p>
          ...
          {activeModal === 'policy' && (
            <div className="fm-text-panel scrollable-y">
              ...
              <p>If your seal is broken upon arrival, **do not consume**. Take clear photos and contact us at support@powertanknutrition.com or WhatsApp within 48 hours. We will ship a replacement tub instantly with zero questions asked.</p>
